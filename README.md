...
<p>
  ...
  <img src="https://img.shields.io/badge/version-1.16.3-blue?style=flat-square" alt="Version 1.16.0">
...
**`v1.16.3`, Gold grade, installable.** The toolkit is a self-proving example of the Standard it defines: it declares `tier: advanced`, and CI grades it there - the gate is green and `tier-report` prints `advanced` with an empty burndown.
