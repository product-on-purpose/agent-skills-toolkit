...
## The site stack
Astro 6 + `@astrojs/starlight` ~0.39 + `astro-mermaid` ~2.0 (mermaid before starlight), the stock `docsLoader()` over a generated Pattern S view of `docs/**` (emitted by `gen-docs-site.mjs` in the `prebuild` hook, gitignored, link-rewritten), GitHub Pages `site` + `base`. Full recipe + gotchas: [docs-site-recipe](../../skills/askit-build-docs/references/docs-site-recipe.md).
