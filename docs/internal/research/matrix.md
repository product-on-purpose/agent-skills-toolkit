...
| 8 Validation depth | strict-CI + manifest-vs-disk (30-check spine) | frontmatter + refs + manifest-vs-disk (score advisory) | frontmatter + refs + harness-portability + strict-CI | frontmatter + refs + budget | strict-CI + frontmatter + refs + budget | deep 5-pass pipeline | frontmatter + refs + budget + manifest-vs-disk | frontmatter + structure (base spec) | frontmatter only (at packaging) | minimal frontmatter syntax |
