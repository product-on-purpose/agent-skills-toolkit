...
| Suite | 1252 | **1376**, 0 failures (1292 at cut time, 1359 at the tag - see the note below) |
...
- Suite: **1376 tests, 0 failures**, 1 skipped. **This read 1292 at cut time and 1359 at the tag**; the seventeen most recent are v1.16.0 W4's capability-matrix drift guard - eleven at W4, three more when adversarial wave 1 found gaps in it, and three more when a probe of the PANEL's own fixes found three defects in them - which has nothing to do with this release and moved this line anyway - see the closing sentence. the sixty-seven added are the `F1` to `F15`
