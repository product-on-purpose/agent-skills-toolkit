...
## Where we are now
- Version **1.6.1**, Standard **0.12**, **30-check spine**, **442 tests**, gate **Advanced 0/0**. Self-grading Gold on every CI build; installable from the `product-on-purpose` marketplace.
