...
| R4 v1.10.0 "manage and studio" | Manage gaps + the studio slice | SP4 (Manage gaps), the GUI read-only slice; optional riders E4 (SARIF output) and E9 (provenance contract), both SHIPPED in v1.11.0, 2026-08-11 | [04-releases/R4-v1.10.0-manage-and-studio.md](04-releases/R4-v1.10.0-manage-and-studio.md) |
