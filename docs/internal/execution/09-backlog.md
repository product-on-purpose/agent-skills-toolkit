...
| E4 (SARIF output) | [enhancements.md](../backlog/enhancements.md), gap-analysis Adopt 1 | Earmarked as R4 (v1.10.0) stretch rider; deferred here only if it does not land | See conditional note above; post-R4 if not landed |
| E9 (provenance output contract) | [enhancements.md](../backlog/enhancements.md), gap-analysis Build 2 | Earmarked as R4 (v1.10.0) stretch rider; deferred here only if it does not land | See conditional note above; post-R4 if not landed |
