...
You do not need to memorize the Standard first. You will meet each Universal check (`U1-U9`, `U11-U17`) at the moment it matters, as the tooling brings it up. The path here is the one the toolkit is built around: loose components, into a plugin, into a graded skill library.
