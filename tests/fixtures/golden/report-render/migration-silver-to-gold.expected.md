...
**Summary: migration of silver-fixture from Silver to Gold: 1 stage(s), 3 blocker(s) to close.**
...
**Summary: the staged ladder from Silver to Gold.**

### To Gold

| Blocker | Check | Effort |
| --- | --- | --- |
| no CI workflow under .github/workflows/; Gold requires self-hosting CI that runs the conformance gate (Standard sec 2.6 G2, sec 4). | G2 | ~20 min |
| RELEASE-NOTES.md is missing at the repository root; Gold requires a curated, user-facing RELEASE-NOTES.md distinct from CHANGELOG.md (Standard sec 2.6 G5, sec 10.6). | G5 | ~15 min |
| INDEX.md is missing; at Gold it is generated by gen-index and drift-checked (Standard sec 2.6 G4). Generate it: npx agent-skills-toolkit gen-index . --write (or `node scripts/generators/gen-index.mjs . --write` if you vendor this toolkit) | G4 | ~5 min |

## 07 Improvement path

**Summary: the staged plan, one copy-paste prompt per blocker, ordered by stage.**

### Stage: reach Gold

- **G2** (~20 min): no CI workflow under .github/workflows/; Gold requires self-hosting CI that runs the conformance gate (Standard sec 2.6 G2, sec 4).
...
- **G5** (~15 min): RELEASE-NOTES.md is missing at the repository root; Gold requires a curated, user-facing RELEASE-NOTES.md distinct from CHANGELOG.md (Standard sec 2.6 G5, sec 10.6).
...
- **G4** (~5 min): INDEX.md is missing; at Gold it is generated by gen-index and drift-checked (Standard sec 2.6 G4). Generate it: npx agent-skills-toolkit gen-index . --write (or `node scripts/generators/gen-index.mjs . --write` if you vendor this toolkit)
