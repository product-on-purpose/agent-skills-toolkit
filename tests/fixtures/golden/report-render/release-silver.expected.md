...
**Summary: one row per requirement, all 35 itemized, grouped by tier. Every non-pass carries a why-it-matters note.**

### Bronze / Universal (17 checks) - 17 of 17 satisfied
...
| U18 command-size-cap | PASS | - | Requirement satisfied; no finding raised. Module: checks/command-size-cap.mjs. |
...
| CLAUSE | Advanced Skill Library Standard v0.8 - the 35-check spine and the Bronze / Silver / Gold tier definitions this report grades against. |
