...
## Scope (v1)
This skill is the conformance-core assessment. Behavioral evaluation (running a skill against expected outputs) and qualitative review are out of scope here and arrive in a later phase. See [references/report-format.md](references/report-format.md) for the report shape.
