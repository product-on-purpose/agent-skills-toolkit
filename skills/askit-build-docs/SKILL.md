...
Five rules, each from a defect found in this repository's own public docs on 2026-08-23 and 2026-08-24. The per-quadrant page anatomy, the measurable floor, and the worked exemplar are in [references/style-contract.md](references/style-contract.md); measure a page before and after any rewrite rather than judging your own prose.
