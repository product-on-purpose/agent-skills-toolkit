...
import * as catalogueManifestShape from "../checks/catalogue-manifest-shape.mjs";
import * as commandSizeCap from "../checks/command-size-cap.mjs";
...
export const CHECKS = [
  ...
  perTargetPresence,
  versionMatch, mermaidValid, mcpValid, skillRegistration, agentRestrictedFields, agentsDirRegisterable, metadataPlacement, catalogueManifestShape, commandSizeCap,
